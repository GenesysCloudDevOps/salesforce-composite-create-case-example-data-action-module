A Terraform/CX as Code remote module for the following Salesforce API operation: Composite Create Case Example
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/salesforce-composite-create-case-example-data-action-module.git?ref=v1.0.0"
    action_name        = "Composite Create Case Example"
